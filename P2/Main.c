...
-----------------------------  SynchTest  ---------------------------------
  ...
  function main ()
      ...
      -- ProducerConsumer ()
      -- DiningPhilosophers ()
	  print("Is this thing on? <tap tap>")
...
-----------------------------  SimpleThreadExample  ---------------------------------
  ...
  function SimpleThreadExample ()
    ...
    --    
	  ...
	  --SomeOtherThreadFuction()
    endFunction
	
  function SomeOtherThreadFuction()
	var bThread: Thread
	bThread = new Thread
	bThread.Init ("Steve-the-Thread")
	bThread.Fork (SimpleThreadFunction, 2)
	SimpleThreadFunction (3)
  endFunction
